...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler
	@ResponseStatus(code = HttpStatus.NOT_FOUND)
	public GlobalErrorResponse handelSessionNotFoundException(SessionNotFoundException exc) {

		res.setInternalMessage("Sessionis did not find");
		res.setMessage("Sessiya tapilmadi");
		res.setCode(404);
		return res;
	}
	...
	@ExceptionHandler
	@ResponseStatus(code = HttpStatus.NOT_FOUND)
	public GlobalErrorResponse handelResourceNotFoundException(ResourceNotFoundException exc) {
